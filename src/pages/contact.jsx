  ...
  return (
    ...
    <div class="my-6 py-24">
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                <div>
                    <h1 class="text-3xl font-extrabold">Let's Chat</h1>
                    <p class="text-sm text-gray-400 mt-3">Whether you have a question, want to start a project or simply want to connect.</p>
                    ...
                    <div class="mt-12">
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                ...
                                <a target="blank" href="https://topazalpha@gmail.com" class="text-[#007bff] text-sm ml-3">
                                    <small class="block">Mail</small>
                                    <strong>https://topazalpha@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
