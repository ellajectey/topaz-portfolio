                    ...
                    <div className="flowbite-card-content">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            {displaySkills.map((skill, index) => (
                                <a key={index} href="/about" className="block max-w-sm p-6 bg-yellow-900 border-4 border-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 transform transition hover:bg-opacity-50 hover:bg-yellow-900">
